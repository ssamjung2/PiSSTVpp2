 ...
 *
 * ## Overview
 * This module provides a centralized error handling system for SlowFrame. Instead of
 ...
 *
 * // Log with context
 * error_log(SLOWFRAME_ERR_IMAGE_LOAD, "Failed to load: %s", filename);
 *
...
#define SLOWFRAME_OK 0

// Argument/CLI Errors (100-199)
/** Generic argument error */
#define SLOWFRAME_ERR_ARG_INVALID 101
/** Missing required argument */
#define SLOWFRAME_ERR_ARG_MISSING 102
/** Unrecognized command-line option */
#define SLOWFRAME_ERR_ARG_UNKNOWN_OPTION 103
/** Invalid option value */
#define SLOWFRAME_ERR_ARG_VALUE_INVALID 104
/** Filename too long or invalid */
#define SLOWFRAME_ERR_ARG_FILENAME_INVALID 105
/** Invalid SSTV mode/protocol code */
#define SLOWFRAME_ERR_ARG_MODE_INVALID 106
/** Invalid aspect ratio correction mode */
#define SLOWFRAME_ERR_ARG_ASPECT_MODE_INVALID 107
/** Invalid audio format specified */
#define SLOWFRAME_ERR_ARG_FORMAT_INVALID 108
/** Invalid sample rate */
#define SLOWFRAME_ERR_ARG_SAMPLE_RATE_INVALID 109
/** CW signature option invalid */
#define SLOWFRAME_ERR_ARG_CW_INVALID 110
/** No input file specified (-i required) */
#define SLOWFRAME_ERR_NO_INPUT_FILE 111
/** Invalid SSTV protocol specified */
#define SLOWFRAME_ERR_ARG_INVALID_PROTOCOL 112
/** Invalid audio format specified */
#define SLOWFRAME_ERR_ARG_INVALID_FORMAT 113
/** Invalid sample rate specified */
#define SLOWFRAME_ERR_ARG_INVALID_SAMPLE_RATE 114
/** Invalid aspect ratio mode specified */
#define SLOWFRAME_ERR_ARG_INVALID_ASPECT 115
/** Invalid or too-long callsign for CW signature */
#define SLOWFRAME_ERR_ARG_CALLSIGN_INVALID 116
/** Invalid CW words-per-minute value */
#define SLOWFRAME_ERR_ARG_CW_INVALID_WPM 117
/** Invalid CW tone frequency */
#define SLOWFRAME_ERR_ARG_CW_INVALID_TONE 118
/** CW parameters used without callsign (-C required) */
#define SLOWFRAME_ERR_ARG_CW_MISSING_CALLSIGN 119
/** Filename too long (exceeds max path length) */
#define SLOWFRAME_ERR_ARG_FILENAME_TOO_LONG 120

// Image Errors (200-299)
/** Generic image loading error */
#define SLOWFRAME_ERR_IMAGE_LOAD 201
/** Image format not supported */
#define SLOWFRAME_ERR_IMAGE_FORMAT_UNSUPPORTED 202
/** Image dimensions out of range */
#define SLOWFRAME_ERR_IMAGE_DIMENSIONS_INVALID 203
/** Image processing/transformation failed */
#define SLOWFRAME_ERR_IMAGE_PROCESS 204
/** Aspect ratio correction failed */
#define SLOWFRAME_ERR_IMAGE_ASPECT_CORRECTION 205
/** Image memory allocation failed */
#define SLOWFRAME_ERR_IMAGE_MEMORY 206
/** Text overlay operation failed */
#define SLOWFRAME_ERR_IMAGE_TEXT_OVERLAY 207
/** Color bar operation failed */
#define SLOWFRAME_ERR_IMAGE_COLOR_BAR 208

// SSTV Errors (300-399)
/** Generic SSTV encoding error */
#define SLOWFRAME_ERR_SSTV_ENCODE 301
/** SSTV mode not found in registry */
#define SLOWFRAME_ERR_SSTV_MODE_NOT_FOUND 302
/** SSTV initialization failed */
#define SLOWFRAME_ERR_SSTV_INIT 303
/** SSTV mode registry error */
#define SLOWFRAME_ERR_SSTV_REGISTRY 304
/** Mode resolution mismatch */
#define SLOWFRAME_ERR_SSTV_MODE_RESOLUTION 305
/** VIS header encoding failed */
#define SLOWFRAME_ERR_SSTV_VIS 306
/** CW signature encoding failed */
#define SLOWFRAME_ERR_SSTV_CW 307

// Audio Errors (400-499)
/** Generic audio encoding error */
#define SLOWFRAME_ERR_AUDIO_ENCODE 401
/** Audio format not supported */
#define SLOWFRAME_ERR_AUDIO_FORMAT_UNSUPPORTED 402
/** Audio sample rate not supported */
#define SLOWFRAME_ERR_AUDIO_SAMPLE_RATE_UNSUPPORTED 403
/** Audio buffer allocation failed */
#define SLOWFRAME_ERR_AUDIO_MEMORY 404
/** WAV encoding failed */
#define SLOWFRAME_ERR_AUDIO_WAV 405
/** AIFF encoding failed */
#define SLOWFRAME_ERR_AUDIO_AIFF 406
/** OGG Vorbis encoding failed */
#define SLOWFRAME_ERR_AUDIO_OGG 407

// File I/O Errors (500-599)
/** Cannot open file */
#define SLOWFRAME_ERR_FILE_OPEN 501
/** Cannot read file */
#define SLOWFRAME_ERR_FILE_READ 502
/** Cannot write file */
#define SLOWFRAME_ERR_FILE_WRITE 503
/** File does not exist */
#define SLOWFRAME_ERR_FILE_NOT_FOUND 504
/** File path invalid */
#define SLOWFRAME_ERR_FILE_PATH_INVALID 505
/** File I/O permission denied */
#define SLOWFRAME_ERR_FILE_PERMISSION 506
/** Disk full or write error */
#define SLOWFRAME_ERR_FILE_DISK_FULL 507

// System/Memory Errors (600-699)
/** Memory allocation failed */
#define SLOWFRAME_ERR_MEMORY_ALLOC 601
/** System resource limit exceeded */
#define SLOWFRAME_ERR_SYSTEM_RESOURCE 602
/** System call failed */
#define SLOWFRAME_ERR_SYSTEM_CALL 603

// MMSSTV Library Errors (700-799)
/** MMSSTV library not found */
#define SLOWFRAME_ERR_MMSSTV_NOT_FOUND 701
/** MMSSTV library initialization failed */
#define SLOWFRAME_ERR_MMSSTV_INIT 702
/** MMSSTV mode not found */
#define SLOWFRAME_ERR_MMSSTV_MODE_NOT_FOUND 703
/** MMSSTV encoding failed */
#define SLOWFRAME_ERR_MMSSTV_ENCODE 704
/** MMSSTV library incompatible */
#define SLOWFRAME_ERR_MMSSTV_INCOMPATIBLE 705

// Text Overlay Errors (800-899)
/** Text overlay initialization failed */
#define SLOWFRAME_ERR_TEXT_OVERLAY_INIT 801
/** Invalid text overlay parameters */
#define SLOWFRAME_ERR_TEXT_OVERLAY_PARAMS 802
/** Text rendering failed */
#define SLOWFRAME_ERR_TEXT_RENDER 803
/** Color bar creation failed */
#define SLOWFRAME_ERR_COLOR_BAR_CREATE 804

// Generic/Unknown Errors
/** Generic unknown error */
#define SLOWFRAME_ERR_UNKNOWN 1000
 ...
 * **Examples:**
 * @code
 * int error_code = SLOWFRAME_ERR_IMAGE_LOAD;
 * printf("Error: %s\n", error_string(error_code));
 * // Output: "Error: Failed to load image from file"
 *
 * printf("Code %d: %s\n", SLOWFRAME_OK, error_string(SLOWFRAME_OK));
 * // Output: "Code 0: Operation completed successfully"
 * @endcode
 *
 * @param error_code The error code to look up (defined as SLOWFRAME_ERR_*)
 * @return Pointer to static string describing the error (never NULL)
 *
 * @see SLOWFRAME_OK, SLOWFRAME_ERR_IMAGE_LOAD, SLOWFRAME_ERR_SSTV_INIT
 */
 ...
 * error_log(SLOWFRAME_ERR_IMAGE_LOAD, "Loading: %s", filename);
 ...
 * error_fatal_exit(SLOWFRAME_ERR_IMAGE_LOAD, "Could not find input image");
 *
 * // Exit with code 1 (no specific error)
 * error_fatal_exit(SLOWFRAME_ERR_UNKNOWN, "Something went wrong");
 * @endcode
 *
